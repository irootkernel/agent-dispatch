...
| SQLite | Pure-Go driver preferred for reproducible builds across the supported platforms (`darwin/arm64`, `linux/amd64`, `linux/arm64` under D-029); CGO requires an explicit ADR (hosted CI is not used, D-017). |
