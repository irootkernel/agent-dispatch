...
- The roadmap contains exactly 9 epics and 51 task headings (the 33 v0.1 tasks, the 12 E7 remediation tasks from D-017, and the 6 E8 remediation tasks from D-020).
- Every task uses one allowed status value.
- The v0.1 and E7 sequences are fully Completed; the E8 remediation tasks are tracked live in the task status index (see D-020).
...
- Roadmap tasks: 51 (33 v0.1 + 12 E7 + 6 E8 remediation)
