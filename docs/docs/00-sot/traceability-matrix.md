...
| `CLI-*` | E1-T1, E2-T4, E3-T3, E5-T1, E5-T4, E6-T2 | E6-T4 |
| `CON-*` | E3-T1, E3-T4, E5-T3, E5-T5 | E5-T5 |
| `DAT-*` | E0-T2, E1-T3, E1-T4, E2-T3 | E3-T5 |
| `DUR-*` | E0-T2, E1-T4, E3-T1, E3-T2, E3-T3, E3-T5, E4-T3, E4-T5 | E3-T5, E4-T5 |
| `FBK-*` | E0-T2, E3-T4, E5-T1, E5-T2, E5-T3, E5-T5 | E5-T5 |
| `HER-*` | E0-T2, E0-T4, E4-T1, E4-T2, E4-T3, E4-T4, E4-T5 | E4-T5, E6-T4 |
| `OPS-*` | E1-T2, E1-T4, E2-T5, E3-T5, E4-T4, E5-T4, E6-T2, E6-T3 | E6-T4 |
| `POL-*` | E1-T2, E2-T4, E5-T4 | E5-T5 |
| `PTH-*` | E1-T2, E2-T2, E2-T3, E5-T4 | E2-T5, E5-T5 |
| `SCP-*` | E0-T1, E1-T1, E1-T2, E1-T4, E2-T3, E6-T3 | E6-T3, E6-T4 |
| `SEC-*` | E0-T2, E1-T2, E2-T1, E2-T2, E2-T4, E4-T1, E4-T2, E5-T1, E6-T1, E6-T2 | E5-T5, E6-T4 |
| `SRC-*` | E0-T5, E2-T1, E2-T3, E2-T5, E5-T4 | E2-T5, E6-T3 |
| `TST-*` | E0-T3, E0-T4, E0-T5, E1-T1, E1-T3, E1-T4, E2-T1, E2-T3, E2-T4, E2-T5, E3-T1, E3-T2, E3-T3, E3-T5, E4-T3, E4-T5, E5-T5 | E6-T4 |
| `WHK-*` | E6-T1 | E6-T4 |
