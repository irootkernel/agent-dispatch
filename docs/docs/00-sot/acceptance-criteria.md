...
| AC-107 | Given `WATCHMAN_FILES_OVERFLOW=true`, a fresh instance, or unusable source position, when planned, then no partial normal task is produced and one reconciliation decision is persisted or printed. |
