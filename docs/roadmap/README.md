...
The approved v0.1.5 sequence progresses through source/reconciliation
integrity, Hermes preflight/setup, multi-destination lifecycle, and
notifications/release. Consult `roadmap.md` for the current task and status;
this index intentionally does not duplicate mutable lifecycle values.
