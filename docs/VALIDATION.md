...
> **Validated:** 2026-08-24 (post E8 closeout and E9 registration; the deferred hardening inventory is accepted under D-021 — epic E9 is open)  
> **Package target:** Agent Dispatch SOT 1.0.36 / implementation v0.1.2 (v0.1.3 under hardening in epic E9)
...
- The roadmap contains exactly 10 epics and 56 task headings (the 33 v0.1 tasks, the 12 E7 tasks from D-017, the 6 E8 tasks from D-020, and the 5 E9 tasks from D-021).
- Every task uses one allowed status value.
- The v0.1, E7, and E8 sequences are fully Completed; the E9 hardening tasks are tracked live in the task status index (see D-021).
...
- Roadmap tasks: 56 (33 v0.1 + 12 E7 + 6 E8 + 5 E9)
