...
// D-028 (SRC-013): binding validation is anchored on the configuration
// alone — the canonicalized WATCHMAN_ROOT must equal the configured
// resource root — so dispatch reads no persisted Watchman binding and
