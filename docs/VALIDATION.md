...
> **Validated:** 2026-08-25 (D-025 v0.1.5 design-baseline registration; implementation gates G6-G9 remain Planned)
> **Package target:** Agent Dispatch SOT 1.1.0 / implementation v0.1.5 (planned); v0.1.4 is shipped
...
- The D-025/SOT 1.1.0 additions preserve the package's existing prose style and introduce no hidden executable-evidence claim for Planned work.

## Package Statistics at Validation

- Markdown files: 73 on the manifest basis (including the v0.1.5 source record, target architecture, and ADR-0016 through ADR-0019)
- JSON Schemas: 12
- Example files: 12
...
- gates G6 through G9 and AC-601 through AC-906; their task owners are E10 through E13 and no executable evidence is claimed by SOT 1.1.0;
