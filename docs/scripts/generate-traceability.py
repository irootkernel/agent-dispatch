#!/usr/bin/env python3
"""Generate docs/00-sot/traceability-matrix.md from the roadmap and required-spec.
...
SPEC = DOCS / "docs/00-sot/required-spec.md"
ROADMAP = DOCS / "docs/03-roadmap/roadmap.md"
OUT = DOCS / "docs/00-sot/traceability-matrix.md"
