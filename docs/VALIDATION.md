...
| AC-505 Linux CI suite pass | The ubuntu-latest leg of `make verify` (`.github/workflows/ci.yml`, SCP-008): unit, race, migration, crash, and fixture tests plus `schedule-check`'s `systemd-analyze verify` |
